...
if (dato & (1<<4)) PORTCbits.RC0 = 1; else PORTCbits.RC0 = 0;
if (dato & (1<<5)) PORTCbits.RC1 = 1; else PORTCbits.RC1 = 0;
if (dato & (1<<6)) PORTCbits.RC2 = 1; else PORTCbits.RC2 = 0;
if (dato & (1<<7)) PORTBbits.RB3 = 1; else PORTBbits.RB3 = 0;
PORTAbits.RA3 = 1;
__nop();
PORTAbits.RA3 = 0;
